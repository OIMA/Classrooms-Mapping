...
public class HorarioAulaController extends AbstractController {
    ...
    public String consultarAula(Model model, int id, Principal p) {
    ...
    public @ResponseBody
    String obtenerListaGruposPorMateria(Model modelo, String tipoHorario, int idMateria, BigDecimal idAula, Principal p) {
        String listaOptions = "";
...
//            listaTodos.add(grupo);
    ...
    public @ResponseBody
    String obtenerListaGrupos(Model modelo, String tipoHorario, Principal p) {
        String listaOptions = "";
        List<CatalogoGrupos> listaTeoricos = new ArrayList<CatalogoGrupos>();
        List<CatalogoGrupos> listaPracticos = new ArrayList<CatalogoGrupos>();
...
//        JOptionPane.showMessageDialog(null, idGrupo);
    ...
    public @ResponseBody
    String insertarHorario(Model model, int idAula, int idGrupo, String dia, String horario, String tipoHorario) {
        ...
        for (HorarioAula h : horarioAulaFacade.findBySpecificField("dia", dia, "equal", null, null)) {
            if (h.getHorario().equals(horario)) {
                if (nuevoHorario.getIdGrupo().getIdProfesor().equals(h.getIdGrupo().getIdProfesor())) {
                    System.out.println("imposible insertar profesor");
                    return "Este profesor ya tiene este horario";
                }
            }
        }
        if (tipoHorario.equals("P")) {
...
//        System.out.println(g.getForzarGrupo());
//        System.out.println(aula.getTipoAula());
//        System.out.println(idAula);
//        if ("T".equals(g.getForzarGrupo()) && aula.getTipoAula() == 1) {
//            System.out.println("Grupo teorico forzado en aula teorica");
//        } else if ("P".equals(g.getForzarGrupo()) && aula.getTipoAula() == 0) {
//            System.out.println("Grupo practico forzado en aula practica");
//        } else if ("T".equals(g.getForzarGrupo()) && aula.getTipoAula() == 0) {
//            System.out.println("Intento de forzar grupo teorico en aula practica");
//        } else if ("P".equals(g.getForzarGrupo()) && aula.getTipoAula() == 1) {
//            System.out.println("Intento de forzar grupo practico en aula teorica");
//        } else if ((g.getForzarGrupo() == null || "null".equals(g.getForzarGrupo())) && aula.getTipoAula() == 0) {
//            System.out.println("grupo no forzado en aula practica");
//        } else if ((g.getForzarGrupo() == null || g.getForzarGrupo().equals("null")) && aula.getTipoAula() == 1) {
//            System.out.println("grupo no forzado en aula teorica");
//        } else {
//            System.out.println("Ningun caso en horario aula controller NuevoHorario.xx");
//        }
