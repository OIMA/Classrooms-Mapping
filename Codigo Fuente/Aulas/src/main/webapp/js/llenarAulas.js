...
//                        alert('entro');
                        ...
                        if (idMateria === '-1') {
                            ...
                            obtenerGruposPorMateria("T", idMateria, $GET['idAulaString']);
                        }
                    } else {
...
//                        alert(idMateria);
                        if (idMateria === '-1') {
                            ...
                            obtenerGruposPorMateria("P", idMateria, $GET['idAulaString']);
                        }
                    }
//-------------------------------------------------FIN----------------------------------------------\\                    
                    if (tipoAula === '0') {
...
$("#grupoModal").change(
        function() {
            ...
            $("#tablaModal").html('<img id="loading" alt="" src="<%=request.getContextPath()%>/images/cargagif.gif"/>');
        }
);
...
//            alert(idMateria);
            obtenerGruposPorMateria(tipoHorario, idMateria, $GET['idAulaString']);
        }
);
...
function obtenerGruposPorMateria(tipoHorario, idMateria, idAula) {
//    alert(tipoHorario);
    $.ajax({
        type: "GET",
